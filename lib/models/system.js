...
SystemModel.prototype.sendPeriodicMetrics = function() {
  Kadira.datadogClient.gauge('kadira.sessions', _.keys(Meteor.default_server.sessions).length);
};
